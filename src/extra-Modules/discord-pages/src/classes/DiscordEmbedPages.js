...
class DiscordEmbedPages {
    ...
    constructor({
         ...
         * @type {Array<Discord.EmbedBuilder>}
         */
        this.pages = pages;
    ...
    createPages() {
        ...
        if (this.pageFooter) this.pages[0].setFooter({text:`Page: 1/${this.pages.length}`});
    ...
    nextPage() {
        ...
        if (this.pageFooter) embed.setFooter({text:`Page: ${this.currentPageNumber + 1}/${this.pages.length}`});
    ...
    addPage(embed) {
        ...
        if (this.pageFooter) currentEmbed.setFooter({text:`Page: ${this.currentPageNumber + 1}/${this.pages.length}`});
